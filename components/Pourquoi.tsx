type Reason = { icon: string; bg: string; title: string; text: string };

const reasons: Reason[] = [
  { icon: "⚡", bg: "#f0603a", title: "Réactivité", text: "Un appel, une réponse rapide et un rendez-vous sans attendre des jours." },
  { icon: "☎", bg: "#16a3b8", title: "Urgences 7j/7", text: "Fuite ou panne le week-end ? Nous intervenons en dépannage d'urgence." },
  { icon: "◎", bg: "#e9b872", title: "Toute la Corse-du-Sud", text: "D'Ajaccio à Bonifacio, nous couvrons l'ensemble du territoire." },
  { icon: "✓", bg: "#3fd6a8", title: "Professionnalisme", text: "Travail soigné, devis transparent et conseils honnêtes." },
];
    ...
    >
      ...
      <div className="mt-9 grid grid-cols-[repeat(auto-fit,minmax(215px,1fr))] gap-4">
        {reasons.map((r) => (
          ...
          >
            <div
              className="mb-[14px] flex h-[40px] w-[40px] items-center justify-center rounded-[11px] text-[19px]"
